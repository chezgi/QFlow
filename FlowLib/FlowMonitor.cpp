...
//---------------------------------------- Q_PROPERTY
bool FlowMonitor::debug() const
{
    return m_debug;
}


//int FlowMonitor::maxEventHistory() const
//{
//    return m_maxEventHistory;
//}

//QVariantList FlowMonitor::eventHistory() const
//{
//    return m_eventHistory;
//}

QVariantMap FlowMonitor::currentStatus() const
{
    return m_currentStatus;
}

QVariantList FlowMonitor::alertHistory() const
{
    return m_alertHistory;
}

int FlowMonitor::maxAlertHistory() const
{
    return m_maxAlertHistory;
}

void FlowMonitor::setDebug(bool arg)
{
    if (m_debug != arg) {
        m_debug = arg;
...
//void FlowMonitor::setMaxEventHistory(int arg)
//{
//    if (m_maxEventHistory != arg) {
//        m_maxEventHistory = arg;
//        while(m_eventHistory.count() > m_maxEventHistory)
//            m_eventHistory.pop_front();
//        emit maxEventHistoryChanged(arg);
//    }
//}

void FlowMonitor::setMaxAlertHistory(int arg)
{
